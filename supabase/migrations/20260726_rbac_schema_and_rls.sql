...
-- ============================================================================
-- EDGE RUNTIME CONSTRAINT COMPATIBILITY NOTE:
-- In edge runtimes (e.g. Cloudflare Workers, Vercel Edge), native Node CJS bindings
-- are unavailable. The above RLS policies use standard PostgreSQL functions (auth.uid())
-- and Supabase HTTP REST/GraphQL drivers, making them 100% Edge-Safe and immune to
-- Node.js native runtime errors.
-- ============================================================================
