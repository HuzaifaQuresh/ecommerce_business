...
export const SEO_TOPIC_LINKS: {
  ...
  { label: "Zigbee Sensors", to: "/iot-sensors", hash: "zigbee" },
  { label: "WiFi Sensors", to: "/iot-sensors", hash: "wifi" },
  { label: "MQTT Sensors", to: "/iot-sensors", hash: "mqtt" },
  { label: "Tuya Sensors Pakistan", to: "/products", search: { category: "Tuya Smart Sensors" } },
  { label: "IoT Devices", to: "/products", search: { category: "IoT Solutions" } },
