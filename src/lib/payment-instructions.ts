...
export const PAYMENT_INSTRUCTIONS: Record<string, string> = {
  easypaisa:
    "Send the exact order total to SmartZone EasyPaisa 0332-3059259. Use your order ID as the transaction reference and email a screenshot to info@smartzone.pk.",
  jazzcash:
  ...
  bank: "Transfer to SmartZone — HBL IBAN PK00 HABB 0000 0000 1234 5678. Email transfer proof with order ID to info@smartzone.pk.",
