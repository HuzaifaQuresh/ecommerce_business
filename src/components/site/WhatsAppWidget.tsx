...
export function WhatsAppWidget() {
  ...
  return (
    <a
      ...
      className="fixed right-4 bottom-20 md:bottom-6 z-50 w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl transition hover:scale-110 active:scale-95"
    >
